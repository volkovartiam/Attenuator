...
void printTmByCommand_RK(String coms){
  ...
  if( isTm_RK ) {
      ...
      setRegisterAndPrintTM_RK(coms, RK_TM_DM0, 3, 2, 1);           //
      setRegisterAndPrintTM_RK(coms, RK_TM_DM1, 131, 130, 129);     //
      setRegisterAndPrintTM_RK(coms, RK_TM_DM2, 67, 66, 65);        //    
      setRegisterAndPrintTM_RK(coms, RK_TM_DM3, 195, 194, 193);     //

      setRegisterAndPrintTM_RK(coms, RK_TM_DM4, 35, 34, 33);        //
      setRegisterAndPrintTM_RK(coms, RK_TM_DM5, 163, 162, 161);     //
      setRegisterAndPrintTM_RK(coms, RK_TM_DM6, 99, 98, 97);        //
      setRegisterAndPrintTM_RK(coms, RK_TM_DM7, 227, 226, 225);     //     

      setRegisterAndPrintTM_RK(coms, RK_TM_DM8, 19, 18, 17);        //
      setRegisterAndPrintTM_RK(coms, RK_TM_DM9, 147, 146, 145);     //
      setRegisterAndPrintTM_RK(coms, RK_TM_DM10, 83, 82, 81);       //
      setRegisterAndPrintTM_RK(coms, RK_TM_DM11, 211, 210, 209);    //

      setRegisterAndPrintTM_RK(coms, RK_TM_DM12, 51, 50, 49);       //
      setRegisterAndPrintTM_RK(coms, RK_TM_DM13, 179, 178, 177);    //
      setRegisterAndPrintTM_RK(coms, RK_TM_DM14, 115, 114, 113);    //
      setRegisterAndPrintTM_RK(coms, RK_TM_DM15, 243, 242, 241);    //

      setRegisterAndPrintTM_RK(coms, RK_TM_5Vout2  , 11, 10, 9);      //
      setRegisterAndPrintTM_RK(coms, RK_TM_4V_2_2  , 139, 138, 137);  //
      setRegisterAndPrintTM_RK(coms, RK_TM_4V_1_2  , 75, 74, 73);     //
      setRegisterAndPrintTM_RK(coms, RK_TM_4V_2_1  , 203, 202, 201);  //
      setRegisterAndPrintTM_RK(coms, RK_TM_4V_1_1  , 43, 42, 41);     //      
      
      setRegisterAndPrintTM_RK(coms, RK_TM_4V_2out  , 171, 170, 169);   //
      setRegisterAndPrintTM_RK(coms, RK_TM_4V_1out  , 107, 106, 105);   //
      setRegisterAndPrintTM_RK(coms, RK_TM_GND  , 235, 234, 233);       //
      setRegisterAndPrintTM_RK(coms, RK_TM_Neg5Vout2  , 27, 26, 25);    //
      setRegisterAndPrintTM_RK(coms, RK_TM_TEMP2  , 251, 250, 249);     //

      setRegisterAndPrintTemp_RK(coms, RK_TM_TEMP2_C  , 251, 250, 249); //
      delay(delaySerialPrint); 
  }
}
...
void printTmByCommand_OK(String coms){
    ...
    if( isTm_OK ) {
      ...
      setRegisterAndPrintTM_OK(coms, OK_TM_DM0, 3, 2, 1);           //
      setRegisterAndPrintTM_OK(coms, OK_TM_DM1, 131, 130, 129);     //
      setRegisterAndPrintTM_OK(coms, OK_TM_DM2, 67, 66, 65);        //
      setRegisterAndPrintTM_OK(coms, OK_TM_DM3, 195, 194, 193);     //

      setRegisterAndPrintTM_OK(coms, OK_TM_DM4, 35, 34, 33);        //
      setRegisterAndPrintTM_OK(coms, OK_TM_DM5, 163, 162, 161);     //
      setRegisterAndPrintTM_OK(coms, OK_TM_DM6, 99, 98, 97);        //
      setRegisterAndPrintTM_OK(coms, OK_TM_DM7, 227, 226, 225);     // 

      setRegisterAndPrintTM_OK(coms, OK_TM_DM8, 19, 18, 17);        //
      setRegisterAndPrintTM_OK(coms, OK_TM_DM9, 147, 146, 145);     //
      setRegisterAndPrintTM_OK(coms, OK_TM_DM10, 83, 82, 81);       //
      setRegisterAndPrintTM_OK(coms, OK_TM_DM11, 211, 210, 209);    //

      setRegisterAndPrintTM_OK(coms, OK_TM_DM12, 51, 50, 49);       //
      setRegisterAndPrintTM_OK(coms, OK_TM_DM13, 179, 178, 177);    //
      setRegisterAndPrintTM_OK(coms, OK_TM_DM14, 115, 114, 113);    //
      setRegisterAndPrintTM_OK(coms, OK_TM_DM15, 243, 242, 241);    //

      setRegisterAndPrintTM_OK(coms, OK_TM_5Vout1, 11, 10, 9);      //
      setRegisterAndPrintTM_OK(coms, OK_TM_4V_2_2, 139, 138, 137);  //
      setRegisterAndPrintTM_OK(coms, OK_TM_4V_1_2, 75, 74, 73);     //
      setRegisterAndPrintTM_OK(coms, OK_TM_4V_2_1, 203, 202, 201);  //
      setRegisterAndPrintTM_OK(coms, OK_TM_4V_1_1, 43, 42, 41);     // 
      
      setRegisterAndPrintTM_OK(coms, OK_TM_4V_2out, 171, 170, 169);   //
      setRegisterAndPrintTM_OK(coms, OK_TM_4V_1out, 107, 106, 105);   //
      setRegisterAndPrintTM_OK(coms, OK_TM_GND, 235, 234, 233);       //
      setRegisterAndPrintTM_OK(coms, OK_TM_Neg5Vout1, 27, 26, 25);    //
      setRegisterAndPrintTM_OK(coms, OK_TM_TEMP1, 251, 250, 249);     //

      setRegisterAndPrintTemp_OK(coms, OK_TM_TEMP1_C, 251, 250, 249); //
      delay(delaySerialPrint);
    }
}
...
void print_TM_Temp_OK(String com){
      ...
      int valFromADC = analogRead(ADC_OK);
      double valueOK  = (3.3 * valFromADC / 1023) ;  
      double tempOK  =  valueOK/alpha -273  ;  
      Serial.print( tempOK , 2 );                    // 2-знака после запятой
      Serial.print(";");  
      delay(delaySerialPrint);      
}
...
void print_TM_Temp_RK(String com){
      ...
      int valFromADC = analogRead(ADC_RK);
      double valueRK  = (3.3 * valFromADC / 1023) ; 
      double tempRK  =  valueRK/alpha -273 ;   
      Serial.print( tempRK , 2 );                    // 2-знака после запятой
      Serial.print(";");  
      delay(delaySerialPrint);      
}
